...
<html lang="en">
  ...
  <body>
    ...
    <option value="BCom" <?php if(($data['degree'] ?? '') == 'BCom') echo 'selected'; ?>>B.Com</option>
    <option value="BBA" <?php if(($data['degree'] ?? '') == 'BBA') echo 'selected'; ?>>BBA</option>
    <option value="BCA" <?php if(($data['degree'] ?? '') == 'BCA') echo 'selected'; ?>>BCA</option>
